								...
								?>
									<div class="widget-header dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right">
											<a class="dropdown-item" href="<?php echo $sess_role; ?>">My Profile</a>
										...
										<div class="dropdown-menu dropdown-menu-right">
											<article class="card-body">
												...
												<form action="php/login_auth" method="POST">
													...
													<div class="container">
														<div class="row">
															<div style="width: 50%;"><p class="text-left"><a href="sign-up"><small>Sign up </small></a></p></div>
															<div style="width: 50%;"><p class="text-right"><a href="forgot" style="margin-left: 3px;"><small>Forgot password?</small></a></p></div>
														</div>
													</div>
												</form>
											</article>

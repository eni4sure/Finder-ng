...
<?php
	...
	if (isset($_POST['change-pass'])) {
		...
		$get_old_pass = "SELECT * FROM `tbl_users` WHERE member_no='$sess_comp_member_no'";
		...
		if ($current_password == $stored_pass) {
			...
			$update_pass = "UPDATE tbl_users SET passkey = '$new_password' WHERE member_no='$sess_comp_member_no'";
